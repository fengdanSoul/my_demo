...
.date-wrapper{display: flex;width: 100%; background-color: #415ba0;padding: 0 3%;height: 80px;color: white}
.date-wrapper .date,.today{height:100%;display: inline-block;}
.date-wrapper .date{flex: 5;}
.date-wrapper .date .left{display: inline-block;width: 55px;height:80px;text-align:center;line-height: 80px;font-size: 40px;font-weight: 700}
.date-wrapper .date .right{display: inline-block;font-size: 18px;}
.date-wrapper .date .right .week{font-size: 15px;padding-top: 20px;}
.date-wrapper .today{flex: 1;position: relative;}
.date-wrapper .today .text{position: absolute;top: 17px;right:5px;display:block;text-align:center;width: 36px;height:36px;line-height: 36px;border-radius: 50%;border:1px solid #fff;font-size: 16px;}
    ...
    <div class="calendar">
      <div class="date-wrapper">
        <div class="date">
          ...
          <div class="right">
            <div class="week">{{IWeek}}</div>
            <div class="lunar">{{IMonthCn}}{{IDayCn}}</div>
          </div>
        </div>
        <div class="today" @click="setToday()">
          <span class="text">今</span>
        </div>
      </div>
    ...
    methods: {
        ...
        select(k1, k2, e) {
            ...
            if (this.range) {
                ...
                this.setLunar()
              // let lunarInfo=calendar.solar2lunar(this.year,this.month+1,this.day);
              //
              // this.IWeek = lunarInfo.ncWeek;
              //   this.IMonthCn = lunarInfo.IMonthCn;
              //   this.IDayCn = lunarInfo.IDayCn;
